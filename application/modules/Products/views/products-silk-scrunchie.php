                                                ...
                                                <div class="swatch is-color kalles_swatch_js">
                                                    ...
                                                    <ul class="swatches-select swatch__list_pr d-flex">
                                                        <li class="ttip_nt tooltip_top nt-swatch swatch_pr_item is-selected" data-escape="COLOR : 2 RICH SILVER + 1 RICH GOLD">
                                                            <span class="tt_txt">COLOR : 2 RICH GOLD + 1 RICH SILVER</span><span class="swatch__value_pr pr bg_color_gold lazyload" onclick="gold()"></span>
                                                        </li>
                                                        <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item" data-escape="COLOR : 2 RICH GOLD + 1 RICH SILVER">
                                                            <span class="tt_txt">COLOR : 2 RICH SILVER + 1 RICH GOLD</span><span class="swatch__value_pr pr bg_color_silver lazyload" onclick="silver()"></span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>

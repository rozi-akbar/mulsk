                ...
                <div class="row al_center">
                    <div class="col">
                        <nav class="sp-breadcrumb">
                            <a href="<?= site_url('Home') ?>">Home</a><i class="facl facl-angle-right"></i><a href="<?= site_url('Products') ?>">Products</a><i class="facl facl-angle-right"></i>Luxury Gift Set
                        </nav>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row theiaStickySidebar">
                                <div class="col-12 col-lg col_thumb">
                                    <div class="p-thumb p-thumb_ppr images sp-pr-gallery equal_nt nt_contain ratio_imgtrue position_8 nt_slider pr_carousel" data-flickity='{"initialIndex": ".media_id_001","fade":true,"draggable":">1","cellAlign": "center","wrapAround": true,"autoPlay": false,"prevNextButtons":true,"adaptiveHeight": true,"imagesLoaded": false, "lazyLoad": 0,"dragThreshold" : 6,"pageDots": false,"rightToLeft": false }'>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_001" data-mdid="001" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/Luxury-Gift-Set-gold.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/Luxury-Gift-Set-gold.jpg" data-cap="Luxury Gift - color gold"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_002" data-mdid="002" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/luxury-gift-set-2.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/luxury-gift-set-2.jpg" data-cap="Luxury Gift - color gold"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_003" data-mdid="003" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/luxury-gift-set-3.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/luxury-gift-set-3.jpg" data-cap="Luxury Gift - color gold"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_004" data-mdid="004" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/Luxury-Gift-Set-silver.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/Luxury-Gift-Set-silver.jpg" data-cap="Luxury Gift - color silver"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/oeko-tex-silver.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/oeko-tex-silver.jpg" data-cap="Luxury Gift - color silver"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-1.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-1.jpg" data-cap="Luxury Gift - color candy cotton"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-2.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-2.jpg" data-cap="Luxury Gift - color candy cotton"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-3.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-3.jpg" data-cap="Luxury Gift - color candy cotton"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-4.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-4.jpg" data-cap="Luxury Gift - color candy cotton"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-5.jpg" data-bgset="<?= base_url() ?>assets/images/products/giftset/gift-set-cottoncandy-5.jpg" data-cap="Luxury Gift - color candy cotton"></div>
                                       <!--  <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_006" data-mdid="006" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/silver-3.jpg" data-bgset="<?= base_url() ?>assets/images/silver-3.jpg" data-cap="Silk Pillowcase - color silver"></div> -->
                                    </div>
                        ...
                        <div class="col-md-6 col-12 product-infors pr_sticky_su">
                            <div class="theiaStickySidebar">
                                <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
                                    <h1 class="product_title entry-title fs__16">Luxury Gift Set</h1>
                                   ...
                                   <!--  <div>
                                    ...
                                    <div class="pr_short_des">
                                        <p class="mg__0">The best gift for your loved ones, have a #berrygoodsleep then wake up with beautiful hair and glowing skin!</p><br>
                                        <p class="mg__0"><b>Bahan:</b> 100% mulberry silk, top grade 6A
                                            <br><b>Ketebalan:</b> 22 momme
                                            <br><b>Ukuran:</b> 52 cm x 72 cm
                                        </p><br>
                                        <p class="mg__0">Isi Mulsk Gift Set : 100% mulberry silk pillowcase, 100% mulberry silk eyemask, 100% mulberry silk scrunchie, silky gentle wash, dan bedtime pillow spray</p>
                                            ...
                                            <div class="variations mb__40 style__circle size_medium style_color des_color_1">
                                                <div class="swatch is-color kalles_swatch_js">
                                                    <h4 class="swatch__title">Color:
                                                        <span class="nt_name_current user_choose_js">RICH GOLD</span>
                                                    </h4>
                                                    <ul class="swatches-select swatch__list_pr d-flex">
                                                        <li class="ttip_nt tooltip_top nt-swatch swatch_pr_item is-selected" data-escape="Rich Gold">
                                                            <span class="tt_txt">RICH GOLD</span><span class="swatch__value_pr pr bg_color_gold lazyload" onclick="gift_gold()"></span>
                                                        </li>
                                                        <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item" data-escape="Rich Silver">
                                                            <span class="tt_txt">RICH SILVER</span><span class="swatch__value_pr pr bg_color_silver lazyload" onclick="gift_silver()"></span>
                                                        </li>
                                                        <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item" data-escape="Cotton Candy">
                                                            <span class="tt_txt">COTTON CANDY</span><span class="swatch__value_pr pr bg_color_candy lazyload" onclick="gift_cotton_candy()"></span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div class="kalles-section-pr_description kalles-section kalles-tabs sp-tabs nt_section">
                    ...
                    <div class="panel entry-content sp-tab des_mb_2 des_style_1 active" id="tab_product_description">
                        ...
                        <div class="sp-tab-content cb">
                            <p>Selain Pillow Case, terdapat sebuah Eye Mask yang didesain sangat nyaman di kepala untuk penggunaan selama tidur berjam-jam. Eye Mask Mulsk mampu memaksimalkan penggunaan Eye Serum yang diaplikasikan setiap malam sebelum tidur. Karena terbuat dari sutra murbei tanpa campuran, eye mask Mulsk juga tentu bersifat non-absorbent sehingga tidak akan menyerap produk Eye Serum yang telah dioleskan pada kantung mata pengguna.</p>
                            <p>Sebuah Scrunchie juga termasuk dalam paket hadiah dari Mulsk kali ini. Pengikat rambut yang sepenuhnya menggunakan kain sutra murbei ini tidak akan menyakiti kepala karena rambut tidak ikut tertarik saat melepas ikatannya. </p>
                            <p>Gift set ini juga semakin lengkap dengan Gentle Wash dan Bed Time Pillow Spray. Didesain untuk kenyamanan Anda, Mulsk menggunakan bukaan yang tersembunyi atau model amplop tanpa resleting untuk bagian penutupnya.  Pilihan ukuran sarung bantal yang tersedia adalah 52 x 72 cm.
                            Mulsk Mulberry Silk Pillow Case telah tersertifikasi oleh OEKO-TEX®️ Standard 100 yang telah dites dan bergaransi 100% bebas dari bahan berbaya, toksin, dan subtansi yang dapat mengiritasi kulit dan rambut.
                            </p>
                            
                            <div class="row al_center fl_center bgbl_ pb__35">
                                <div class="col-12 col-md-3 tc tr_md">
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10 order-md-4">
                                            <img width="50" alt="rain" class="lazyload" data-src="<?= base_url() ?>assets/images/svg/icon_inflammation.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                    ...
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10 order-md-4">
                                            <img width="50" alt="sun" data-src="<?= base_url() ?>assets/images/svg/icon_moisture.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                            Menjaga kelembapan alami kulit dan rambut
                                        </div>
                                    </div>
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10 order-md-4">
                                            <img width="50" alt="sea-water" data-src="<?= base_url() ?>assets/images/svg/icon_iritation.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                            Mencegah iritasi
                                        </div>
                                    ...
                                    <div class="row fl_center al_center no-gutters">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10 order-md-4">
                                            <img width="50" alt="sea-water" data-src="<?= base_url() ?>assets/images/svg/icon_hypoallergenic.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                            Hypoallergenic
                                        </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <img class="lazyload w__100 db" data-srcset="<?= base_url() ?>assets/images/products/giftset/luxury-gift-set-silver-desc.png" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="">
                                </div>
                                <div class="col-12 dn_md mt__40"></div>
                                <div class="col-12 col-md-3 tc tl_md">
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10">
                                            <img width="50" alt="sea-water" data-src="<?= base_url() ?>assets/images/svg/icon_keriput.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                            Mengurangi resiko kerutan pada wajah
                                        </div>
                                    </div>
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10">
                                             <img width="50" alt="lead" data-src="<?= base_url() ?>assets/images/svg/icon_rambut kusut.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                            Tidak membuat rambut 
                                            kusut saat 
                                            bangun tidur
                                        </div>
                                    </div>
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10">
                                            <img width="50" alt="spills" data-src="<?= base_url() ?>assets/images/svg/icon_rambut lembap.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                            Membuat rambut 
                                            lebih lembap
                                    ...
                                    <div class="row fl_center al_center no-gutters">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10">
                                            <img width="50" alt="recycle" data-src="<?= base_url() ?>assets/images/svg/icon_sejuk.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">
                                             Terasa sejuk dan tidak 

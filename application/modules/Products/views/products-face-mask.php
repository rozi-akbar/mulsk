                ...
                <div class="row al_center">
                    <div class="col">
                        <nav class="sp-breadcrumb">
                            <a href="<?= site_url('Home') ?>">Home</a><i class="facl facl-angle-right"></i><a href="<?= site_url('Products') ?>">Products</a><i class="facl facl-angle-right"></i>Mulberry Silk Face Mask
                        </nav>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row theiaStickySidebar">
                                <div class="col-12 col-lg col_thumb">
                                    <div class="p-thumb p-thumb_ppr images sp-pr-gallery equal_nt nt_contain ratio_imgtrue position_8 nt_slider pr_carousel" data-flickity='{"initialIndex": ".media_id_001","fade":true,"draggable":">1","cellAlign": "center","wrapAround": true,"autoPlay": false,"prevNextButtons":true,"adaptiveHeight": true,"imagesLoaded": false, "lazyLoad": 0,"dragThreshold" : 6,"pageDots": false,"rightToLeft": false }'>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_001" data-mdid="001" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/facemask/facemask-1.jpg" data-bgset="<?= base_url() ?>assets/images/products/facemask/facemask-1.jpg" data-cap="Silk Pillowcase - color gold"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_002" data-mdid="002" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/facemask/facemask-2.jpg" data-bgset="<?= base_url() ?>assets/images/products/facemask/facemask-2.jpg" data-cap="Silk Pillowcase - color gold"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_003" data-mdid="003" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/facemask/facemask-3.png" data-bgset="<?= base_url() ?>assets/images/products/facemask/facemask-3.png" data-cap="Silk Pillowcase - color gold"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_004" data-mdid="004" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/facemask/facemask-4.jpg" data-bgset="<?= base_url() ?>assets/images/products/facemask/facemask-4.jpg" data-cap="Silk Pillowcase - color silver"></div>
                                        <div class="img_ptw p_ptw p-item sp-pr-gallery__img w__100 nt_bg_lz lazyload padding-top__127_66 media_id_005" data-mdid="005" data-height="1440" data-width="1128" data-ratio="0.7833333333333333" data-mdtype="image" data-src="<?= base_url() ?>assets/images/products/facemask/facemask-5.jpg" data-bgset="<?= base_url() ?>assets/images/products/facemask/facemask-5.jpg" data-cap="Silk Pillowcase - color silver"></div>
                                    </div>
                        ...
                        <div class="col-md-6 col-12 product-infors pr_sticky_su">
                            <div class="theiaStickySidebar">
                                <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
                                    <h1 class="product_title entry-title fs__16">Mulberry Silk Face Mask</h1>
                                   ...
                                   <!--  <div>
                                    ...
                                    <div class="pr_short_des">
                                        <p class="mg__0">Mulberry Silk is naturally hypoallergenic, lightweight, and breathable making our masks ideal for prolonged wear and all skin types!</p><br>
                                        <p class="mg__0"><b>Bahan:</b> 100% mulberry silk, top grade 6A
                                            <br><b>Ketebalan:</b> 22 momme
                                            <br>Isi Box Face Mask : 1 pcs Face Mask Rich Gold, 1 pcs Face Mask Rich Silver, dan BONUS Silky Gentle Wash
                                        </p>
                                        ...
                                        <div id="callBackVariant_ppr">
                                            <div class="variations mb__40 style__circle size_medium style_color des_color_1">
                                                <div class="swatch is-color kalles_swatch_js">
                                                    <h4 class="swatch__title">1 VARIANT ONLY
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="kalles-section-pr_description kalles-section kalles-tabs sp-tabs nt_section">
                    ...
                    <div class="panel entry-content sp-tab des_mb_2 des_style_1 active" id="tab_product_description">
                        ...
                        <div class="sp-tab-content cb">
                            <p>Masker sutra murbei yang dapat digunakan kembali (reusable) ini pasti akan bermanfaat bagi Anda dalam jangka panjang. Karena adanya sericin dalam kandungan sutra murbei, Anda tidak perlu khawatir tentang kulit yang teriritasi.</p>
                            <p>Satu Ukuran tetapi dapat disesuaikan & fleksibel. Ukuran bebas cocok untuk semua orang. Sangat cocok untuk orang dewasa, wanita, pria. Cukup lebar untuk melindungi hidung, mulut, dan wajah Anda, sangat nyaman dipakai dan mudah bernapas.</p>
                            <p>Telah lolos uji Dermatology Tested serta Oeko Tex Standar 100 sehingga aman jika bersentuhan dengan kulit. Sangat cocok digunakan untuk semua jenis kulit karena mengandung sericin yang bersifat hypoallergenic dan anti-bacterial.
                            </p>
                            ...
                            <div class="row al_center fl_center bgbl_ pb__35">
                                ...
                                <div class="col-12 col-md-6">
                                    <img class="lazyload w__100 db" data-srcset="<?= base_url() ?>assets/images/products/facemask/Face-Mask-square.png" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="">
                                </div>
                                <div class="col-12 dn_md mt__40"></div>
                                <div class="col-12 col-md-3 tc tl_md" style="margin-top: -42px;">
                                    ...
                                    <div class="row fl_center al_center no-gutters mb__60">
                                        <div class="col-12 col-md-auto cl_depr_img ml__10 mr__10">
                                             <img width="50" alt="lead" data-src="<?= base_url() ?>assets/images/svg/icon_rambut_kusut.svg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                                        </div>
                                        <div class="col-12 col-md">

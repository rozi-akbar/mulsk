                                                ...
                                                <div class="swatch is-color kalles_swatch_js">
                                                    ...
                                                    <ul class="swatches-select swatch__list_pr d-flex">
                                                        <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item" data-escape="Silver">
                                                            <span class="tt_txt">Silver</span><span class="swatch__value_pr pr bg_color_silver lazyload" onclick="silver()"></span>
                                                        </li>
                                                        <li class="ttip_nt tooltip_top nt-swatch swatch_pr_item is-selected" data-escape="Gold">
                                                            <span class="tt_txt">Gold</span><span class="swatch__value_pr pr bg_color_gold lazyload" onclick="gold()"></span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
